...
const IntelligentScheduling = () => {
  ...
  return <section id="intelligent-scheduling" className="py-24 bg-gradient-dark text-accent-foreground overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          <div className="relative order-2 lg:order-1">
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-elevated border border-accent-foreground/10">
              <img src={dashboardImage} alt="Intelligent Scheduling Dashboard" className="w-full h-auto" />
            </div>
            ...
            <div className="absolute -right-4 top-8 bg-card text-card-foreground rounded-xl p-4 shadow-elevated animate-float" style={{
            animationDelay: "1s"
          }}>
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-accent-foreground/70 mb-8 leading-relaxed">Vår planeringsmotor arbetar i samma tre nivåer som flygplatser redan har: grundschema, periodplanering och daglig omplanering. Den förstår roller, positioner, kompetenser, tjänstgöringsgrader, regler och beredskap.</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => <div key={i} className="group p-6 rounded-xl bg-accent/50 border border-accent-foreground/10 hover:bg-accent/70 transition-all duration-300">
